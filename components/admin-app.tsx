...
export function AdminApp() {
  ...
  function exportStudentQuiz() {
    ...
    download(generateStudentQuizHtml(quiz, qrLibrarySource), `${safeFilename(quiz.quizId)}.html`, 'text/html');
    setNotice('Standalone student quiz downloaded');
  }
...
function ExportSection({ quiz, errors, exportJson, exportStudentQuiz, importRef, importJson, setQuiz, setNotice }: { quiz: Quiz; errors: string[]; exportJson: () => void; exportStudentQuiz: () => void; importRef: React.RefObject<HTMLInputElement | null>; importJson: (file?: File) => void; setQuiz: React.Dispatch<React.SetStateAction<Quiz>>; setNotice: (notice: string) => void }) {
