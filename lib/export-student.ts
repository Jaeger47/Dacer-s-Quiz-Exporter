...
function studentQuizApplication(quiz: Quiz) {
  ...
  async function createQrParts(result: any) {
    ...
    const raw = new TextEncoder().encode(JSON.stringify(qrResult));
    let bytes = raw;
